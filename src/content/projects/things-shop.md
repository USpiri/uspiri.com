...
Built with Next.js 14 App Router and server components throughout — data mutations via server actions, Prisma + PostgreSQL for persistence, Auth.js for role-based access, PayPal SDK for checkout, and Cloudinary for image delivery.
